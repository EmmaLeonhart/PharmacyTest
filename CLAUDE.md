...
This `CLAUDE.md` was generated by **cleanvibe v1.13.1** on 2026-06-08. cleanvibe ships new skills, template sections, and workflow conventions over time — when one lands, every cleanvibe-scaffolded project should pick it up.
...
- **Last cleanvibe update check:** `2026-06-08`
